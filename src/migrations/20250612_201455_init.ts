...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  DO $$ BEGIN
   ALTER TABLE "feedback_products" ADD CONSTRAINT "feedback_products_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."feedback"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
  ...
  CREATE INDEX IF NOT EXISTS "feedback_products_order_idx" ON "feedback_products" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "feedback_products_parent_id_idx" ON "feedback_products" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "feedback_products" CASCADE;
